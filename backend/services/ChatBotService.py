...
class ChatBotService:
    ...
    def get_assistant_response(self, user_id, business_context, form_description, information_goals, number_of_questions):
    ...
    def get_response(self, user_id, form_id, project_id):
        ...
        return self.get_assistant_response(
            user_id, business_context, form_description, information_goals, number_of_questions
        )
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        chatbot.update_chat_history(user_id, "user", user_response)
        followup = chatbot.get_response(user_id, form_id, project_id)
