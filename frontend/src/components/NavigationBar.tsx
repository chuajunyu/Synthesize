...
export function NavigationBar() {
  ...
  <aside id="sidebar" className="fixed left-0 top-0 z-40 h-screen w-64 transition-transform" aria-label="Sidebar">
    <div className="flex h-full flex-col overflow-y-auto border-r border-slate-300 bg-white px-3 py-4 dark:border-slate-700 dark:bg-slate-900">
      <a href="#" className="mb-10 flex items-center rounded-lg px-3 py-2 text-slate-900 dark:text-white">
      ...
      <ul className="space-y-2 text-sm font-medium mt-4">
        ...
        <li>
          <a href="#" className="flex items-center rounded-lg px-3 py-2 text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700">
            ...
            <span className="ml-3 flex-1 whitespace-nowrap">Forms Created</span>
          </a>
        </li>
        <li>
          <a href="#" className="flex items-center rounded-lg px-3 py-2 text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700">
            ...
            <span className="ml-3 flex-1 whitespace-nowrap">Forms Completed</span>
          </a>
        </li>
        <li>
          <a href="#" className="flex items-center rounded-lg px-3 py-2 text-slate-900 hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700">
            ...
            <span className="ml-3 flex-1 whitespace-nowrap">Create a Form</span>
          </a>
        </li>
      </ul>
      <div className="mt-auto flex">
        <div className="flex w-full justify-between">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" aria-roledescription="more menu" fill="none" stroke="currentColor" stroke-width="2" className="h-5 w-5 text-black dark:text-white" stroke-linecap="round" stroke-linejoin="round">
