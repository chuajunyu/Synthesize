      ...
      <div className="flex mx-8 mt-5">
        <div className="flex flex-col w-full">
          <span className="flex mt-3 mb-3 text-xl font-semibold">
            Creating a form, {name}? Choose between creating one yourself or
            getting AI to do it for you based on your goals!
          </span>
          <div className="flex flex-row w-full space-x-6">
            <Card className="sm:col-span-2 w-1/2">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="w-full">
                  Define your form's title, description, and provide form
            ...
            <Card className="sm:col-span-2 w-1/2">
              <CardHeader className="pb-3">
                <CardTitle>
                  Generate Forms with the Empowerment of AI 🤖
                </CardTitle>
                <CardDescription className="w-full">
                  Introducing our AI-powered form-builder powered by OpenAI's
