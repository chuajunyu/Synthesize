...
export default function Landing() {
    return (
        <div className="flex min-h-screen w-full transform flex-col bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 2xl:px-80">
            <div role="navigation-bar" className="flex flex-row items-center justify-between px-6 py-5 sm:px-12">
                <div>
                ...
                <div>
                    <Link role="login" href="/auth/login">
            ...
            <div role="main-content" className="mt-5 flex flex-col px-4 py-5 sm:px-20 md:flex-row">
                <div role="value-proposition" className="flex flex-col sm:w-1/2">
                    ...
                    <h2 className="mb-5 text-center text-2xl text-white sm:text-left">
                    ...
                    <div className="flex flex-row justify-center sm:justify-start">
                        <Link role="call-to-action" href="/auth/signup">
                ...
                <div className="mb-10 flex flex-col sm:mb-0 sm:w-1/2 sm:justify-center">
                    <Image
                        src="/truffle.png"
                        alt="Example of Synthesize in action"
                        width={500}
                        height={500}
                        className="mt-10 rounded-2xl shadow-xl sm:ml-16"
                    />
                    <p role="testimonial-text" className="mt-3 text-center italic text-white sm:ml-16 sm:text-right">
                        I discovered what my customers thought of McDonald's new
                        Truffle Cheese Sauce in just 5 minutes using Synthesize!
                    </p>
                    <p role="testimonial-author" className="ml-16 text-center font-light italic text-white sm:text-right">
